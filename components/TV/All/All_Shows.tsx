  ...
  return (
    <div className="w-full h-full">
      <div className="mt-20 min-h-screen">
        <h1 className="text-white p-8 font-bold text-2xl">All Shows</h1>
        ...
        {results
          ...
          selectedGenreTitle !== "default" && (
            <div className="text-white px-8 text-xl">
              Please See Next Page. TheMovieDB API Does Not Allow No-Limit
              Fetching.
            </div>
          )}
      </div>
