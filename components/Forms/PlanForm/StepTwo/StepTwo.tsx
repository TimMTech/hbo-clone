...
const StepTwo: React.FC<StepTwoProps> = ({subscribeValues, handleFormChange, handleFormSubmit}) => {
  return (
    <form
      ...
      action=""
      className="md:p-0 text-white flex flex-col justify-start items-center w-full max-w-[700px] p-4 gap-5"
    >
      ...
      <div className=" flex flex-col  items-center justify-center bg-gradient-to-br from-purple-900/90 via-black to-purple-900/50 p-6 mb-5 rounded-md gap-4">
        ...
        <button className="text-xl font-semibold bg-purple-800 w-full max-w-[300px] py-3 shadow-zinc-600 shadow-lg rounded-3xl">
          CREATE ACCOUNT
        </button>
      </div>
    </form>
